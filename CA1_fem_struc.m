...
u_tau = 4*10^-3; % presribed displacement magnitude
...
for i=1:ntime
    ...
    a_C = horzcat(-1/sqrt(2)*u_tau*ones(1,length(dof_upper))*i/ntime , zeros(1,length(dof_lower)))'; %displacements vector
    a(dof_C,1) = a_C;
